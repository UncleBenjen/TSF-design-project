...
urlpatterns = patterns('',
		...
		url(r'^delete_student_group/(?P<course_url>\w+)/(?P<date_url>\w+)/(?P<students_id>\w+)/$',views.delete_students, name='delete_students'),
		url(r'^delete_textbook/(?P<course_url>\w+)/(?P<date_url>\w+)/(?P<book_id>\w+)/$',views.delete_textbook, name='delete_textbook'),
		url(r'^delete_deliverable/(?P<course_url>\w+)/(?P<date_url>\w+)/(?P<deliverable_id>\w+)/$',views.delete_deliverable, name='delete_deliverable'),
		url(r'^delete_objective/(?P<course_url>\w+)/(?P<date_url>\w+)/(?P<objective_id>\w+)/$',views.delete_objective, name='delete_objective'),
		url(r'^delete_ceab_grad/(?P<course_url>\w+)/(?P<date_url>\w+)/(?P<ceab_id>\w+)/$',views.delete_ceab_grad, name='delete_ceab_grad'),
